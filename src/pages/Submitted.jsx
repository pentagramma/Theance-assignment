...
const Submitted = () => {
  ...
  return (
    <div className="w-screen h-screen items-center justify-between">
      ...
      <div className="flex flex-row items-center justify-center text-[#727272] pt-10">

        <h4 className="font-[400] font-abc text-[20px] mt-8 ">Redirecting you to Homepage in {timer} seconds.</h4>
